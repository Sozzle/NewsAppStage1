 ...
 Catch the exception so the app doesn't crash, and print the error message to the logs. */
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                String webPublicationDate = currentArticle.getString("PublicationDate");
                ...
                String webAuthor = currentArticle.getString("WebAuthor");
                ...
                if (tags.length()>0) {
                    ...
                    author = tags.getJSONObject(0).getString("webTitle");
                                 ...
                                 /* Create a new Article object with the title, section, author,

                            date and url from the JSON response. */

                Article article = new Article(SectionName, webPublicationDate, webTitle, webAuthor,webUrl);
