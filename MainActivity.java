...
import static com.example.android.newsappstage1.R.string.no_articles_found_please_try_again_later;
import static com.example.android.newsappstage1.R.string.no_internet_connection_please_check_your_connectivity_and_try_again;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Article>> {
    ...
    public void onLoadFinished(Loader<List<Article>> loader, List<Article> allArticles) {
        ...
        mAdapter.setArticles(allArticles);
    ...
    public void onLoaderReset(Loader<List<Article>> loader) {
        ...
        private class ArticleAsyncTask extends AsyncTask<String, Void, List<Article>> {
            ...
            protected List<Article> doInBackground(String... urls) {
                ...
                List<Article> articles = QueryUtils.fetchArticleData(urls[0]);
                return articles;
            }
